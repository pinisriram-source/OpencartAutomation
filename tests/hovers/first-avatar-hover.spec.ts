...
test.describe('Single Image Hover - First Avatar', () => {
  ...
  test('TC-HOVERS-003: Hovering over first avatar reveals user1 caption and link', { tag: ['@smoke', '@regression'] }, async ({ page }) => {
  ...
  test('TC-HOVERS-004: Moving mouse away from first avatar hides its caption', { tag: ['@sanity', '@regression'] }, async ({ page }) => {
