...
test.describe('Single Image Hover - Second Avatar', () => {
  ...
  test('TC-HOVERS-005: Hovering over second avatar reveals user2 caption and link', { tag: ['@functional', '@regression'] }, async ({ page }) => {
  ...
  test('TC-HOVERS-006: Moving mouse away from second avatar hides its caption', { tag: ['@functional', '@regression'] }, async ({ page }) => {
