...
test.describe('Navigation via View Profile Links', () => {
  ...
  test('TC-HOVERS-013: Clicking View profile link for user1 navigates to /users/1', { tag: ['@smoke', '@regression'] }, async ({ page }) => {
  ...
  test('TC-HOVERS-014: Clicking View profile link for user2 navigates to /users/2', { tag: ['@functional', '@regression'] }, async ({ page }) => {
    // 1. Navigate to the Hovers page
    await hoversPage.navigate();
  ...
  test('TC-HOVERS-015: Clicking View profile link for user3 navigates to /users/3', { tag: ['@functional', '@regression'] }, async ({ page }) => {
    // 1. Navigate to the Hovers page
    await hoversPage.navigate();
