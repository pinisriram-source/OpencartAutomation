...
test.describe('Negative and Boundary Tests', () => {
  ...
  test('TC-HOVERS-016: Hovering over page does not trigger navigation', { tag: ['@sanity', '@regression'] }, async ({ page }) => {
  ...
  test('TC-HOVERS-017: Caption remains hidden when hovering outside avatar area', { tag: ['@functional', '@regression'] }, async ({ page }) => {
    // 1. Navigate to the Hovers page
    // expect: Page loads successfully
    await expect(page).toHaveTitle('The Internet');
  ...
  test('TC-HOVERS-018: Rapid hover changes show correct caption without delay', { tag: ['@functional', '@regression'] }, async ({ page }) => {
    // 1. Navigate to the Hovers page
    // expect: Page loads successfully
    await expect(page).toHaveTitle('The Internet');
  ...
  test('TC-HOVERS-019: Caption hides correctly when mouse leaves page viewport while hovering', { tag: ['@functional', '@regression'] }, async ({ page }) => {
    // 1. Navigate to the Hovers page
    // expect: Page loads successfully
    await expect(page).toHaveTitle('The Internet');
  ...
  test('TC-HOVERS-020: View profile link is not clickable when caption is hidden', { tag: ['@functional', '@regression'] }, async ({ page }) => {
    // 1. Navigate to the Hovers page
    // expect: Page loads successfully
    await expect(page).toHaveTitle('The Internet');
